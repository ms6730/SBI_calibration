...
import scipy.stats  # for skewness
from sbi.inference import SNPE
from pf_ens_functions import get_parflow_output_nc
import subsettools

# -----------------------------------------------------------------------------
# Training includes Mean and Standard Deviation of streamflow only 
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Generate Summary Vectors for Simulated and Observed Streamflow (One Gage Only)
# -----------------------------------------------------------------------------
gage_id = "01608500"
sim_data = []
...
for i in range(num_sims):
    ...
    summary_sim = extract_summary_stats(q_sim_df)
    sim_data.append(summary_sim)
